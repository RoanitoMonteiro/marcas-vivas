...
(function($) {
    ...
    function pageBackground() {
        ...
        if (body.hasClass('image-background')) { // Image background
            $.backstretch(["images/backgrounds/2-img.jpg"]); // Replace here Image Background /backgrounds/2-img.jpg
        } else if (body.hasClass('slideshow-background')) { // Slideshow background
            $.backstretch([
                "images/backgrounds/1-img.jpg", // Add different images
                "images/backgrounds/1-img.jpg",
                "images/backgrounds/1-img.jpg",
                "images/backgrounds/1-img.jpg",
                "images/backgrounds/1-img.jpg"
            ], {
    ...
    var prevIndex = 0;
    $('#fullpage').fullpage({
        anchors: ['inicio', 'sobre-marcas-vivas', 'marcar-vivas-e-pra-quem', 'sobre-mentor'],
        menu: '#header-nav',
        scrollingSpeed: 800,
        autoScrolling: true,
        scrollBar: true,
